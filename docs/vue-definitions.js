    ...
    pullData(selectedData, selectedRegion, updateSelectedCountries = true) {
      ...
      if (selectedRegion != 'US') {
        ...
        if (selectedData == 'casi positivi') {
         url = "https://raw.githubusercontent.com/SpyBal/COVIDSpaghetti/main/spreadsheets/time_series_19-covid-Confirmed_Italy.csv";
        } else if (selectedData == 'deceduti') {
         url = "https://raw.githubusercontent.com/SpyBal/COVIDSpaghetti/main/spreadsheets/time_series_19-covid-Deaths_Italy.csv";
        } else {
          return;
        }
